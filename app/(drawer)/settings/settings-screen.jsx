      ...
      <BackgroundContainer>
            ...
            <View style={{ marginLeft: 15, marginTop: 10, gap: 15 }}>
              ...
              >
                <View style={styles.left}>
                  ...
                  <Text style={styles.settingTitle}>{"deconnexion"}</Text>
                </View>
              </TouchableOpacity>
            </View>
          </View>
            ...
            <View style={{ marginLeft: 15, marginTop: 10, gap: 15 }}>
              ...
              >
                <View style={styles.left}>
                  ...
                  <Text style={styles.settingTitle}>{"partager"}</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.settingsItem}
          ...
          <View style={styles.reinitialisationContent}>
            <View
              style={{
                ...
                borderRadius: 99,
                backgroundColor:
                  "pink" === "pink" ? COLORS.neutral200 : COLORS.neutral250,
                width: 50,
                height: 50,
                marginLeft: "50%",
        ...
        >
          <View style={styles.reinitialisationContent}>
            ...
            >
              {"voulezVousVraimentVousDeconnecter"}
            </Text>
            <View style={styles.btnBox}>
              <TouchableOpacity
