...
const AccountScreen = () => {
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} style={[styles.container, {backgroundColor: 'pink'=== 'pink' ? COLORS.neutral200 : COLORS.neutral100}]}>
            <HeaderWithGoBack title="Compte" navigation={navigation} />
            <View style={styles.profil}>
                <Image source={images.user02} />
                <TouchableOpacity style={styles.flex}>
                    <Text style={[styles.uploadImgText, {color: 'pink'=== 'pink' ? COLORS.accent600 : COLORS.accent800}]}>Changer la photo</Text>
                    <Image source={'pink'=== 'pink' ? icons.uploadIcon : icons.uploadOrangeIcon} style={styles.uploadImg} />
                </TouchableOpacity>
            </View>
            <View style={styles.inputContainer}>
                ...
                <TouchableOpacity style={[styles.saveBtn, {backgroundColor: 'pink'=== 'pink' ? COLORS.accent600 : COLORS.accent800}]}>
